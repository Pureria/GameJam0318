...
{
    public class PlayerMagic3State : PlayerAttackState
    {
        private Vector3 cameraForward;
        
        public PlayerMagic3State(PlayerController player, PlayerInfoSO infoSo, InputSO inputSo, StateMachine stateMachine, Animator anim, string animName, float attackCoolTime) : base(player, infoSo, inputSo, stateMachine, anim, animName, attackCoolTime)
        {
        }
